...
ALTER TABLE "StateChangeProposal" ADD COLUMN "changeProposalId" TEXT;
...
ALTER TABLE "ChangeProposal" ADD CONSTRAINT "ChangeProposal_novelId_fkey"
  FOREIGN KEY ("novelId") REFERENCES "Novel"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "ChangeProposal" ADD CONSTRAINT "ChangeProposal_chapterId_fkey"
  FOREIGN KEY ("chapterId") REFERENCES "Chapter"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "ChangeProposal" ADD CONSTRAINT "ChangeProposal_taskId_fkey"
  FOREIGN KEY ("taskId") REFERENCES "NovelWorkflowTask"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "ChangeProposal" ADD CONSTRAINT "ChangeProposal_supersedesId_fkey"
  FOREIGN KEY ("supersedesId") REFERENCES "ChangeProposal"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "StateChangeProposal" ADD CONSTRAINT "StateChangeProposal_changeProposalId_fkey"
  FOREIGN KEY ("changeProposalId") REFERENCES "ChangeProposal"("id") ON DELETE SET NULL ON UPDATE CASCADE;
